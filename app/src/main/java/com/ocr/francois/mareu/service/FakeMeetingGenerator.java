...
abstract class FakeMeetingGenerator {
    private static List<Meeting> FAKE_MEETINGS = Arrays.asList(
            ...
            new Meeting(2, "sujet 2", MeetingRoom.B, Arrays.asList("etienne@mareu.com", "marine@maru.com"), new LocalDate(2019, 12, 10), new LocalTime(15, 0), new LocalTime(15, 45)),
            new Meeting(3, "sujet 3", MeetingRoom.C, Arrays.asList("caroline@mareu.com", "corrine@mareu.com"), new LocalDate(2019, 12, 10), new LocalTime(15, 15), new LocalTime(15, 40))
    );
