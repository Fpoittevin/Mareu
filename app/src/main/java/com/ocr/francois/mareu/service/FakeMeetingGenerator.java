...
public abstract class FakeMeetingGenerator {
    public static List<Meeting> FAKE_MEETINGS = Arrays.asList(
            new Meeting(1, "Reu 1", MeetingRoom.A, Arrays.asList("email1@gmail.com", "email2@gmail.com"), new LocalDate(2019, 10, 2), new LocalTime(13, 5), new LocalTime()),
            ...
            new Meeting(3, "Reu 3", MeetingRoom.C, Arrays.asList("email5@gmail.com", "email6@gmail.com"), new LocalDate(2019, 10, 2), new LocalTime(13,3), new LocalTime())
    );
